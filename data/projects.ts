...
export const projects: Project[] = [
  {
    ...
    longDescription: "Ticky is a comprehensive task management solution designed for teams. It features real-time collaboration, drag-and-drop task organization, and integrations with popular productivity tools. The application uses WebSockets for instant updates and includes features like task assignment, due dates, priority levels, and file attachments.",
    techStack: [
      "React",
      "Next.js",
      "TypeScript",
    ...
    link: "https://ticky.app",
    githubLink: "https://github.com/vicdevman/ticky",
    demoLink: "https://demo.ticky.app",
    category: ["Web App", "SaaS", "Productivity"],
    featured: true,
  ...
  },
  {
    ...
    description: "Real-time cryptocurrency portfolio tracker with price alerts and analytics",
    longDescription: "CryptoTracker is a comprehensive cryptocurrency portfolio management application that allows users to track their investments across multiple exchanges and wallets. It features real-time price updates, customizable alerts, detailed analytics, and historical performance tracking. The application integrates with major cryptocurrency exchanges via APIs and supports over 5000 cryptocurrencies.",
    techStack: [
      "React",
      "Next.js",
      "TypeScript",
    ...
    link: "https://crypto-tracker.app",
    githubLink: "https://github.com/vicdevman/crypto-tracker",
    demoLink: "https://demo.crypto-tracker.app",
